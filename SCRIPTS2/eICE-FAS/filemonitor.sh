...
then
        ...
        mailx -r "admin@eICEProd" -s  "UNABLE to access /entimice/filesystem/temp/log directory... Please Check immediately.." "sathiskumar.raju@astrazeneca.com purushothaman.krishnan@astrazeneca.com Rohit.Sharma2@astrazeneca.com vinod.sivakumar@astrazeneca.com juanpablo.ramirez@astrazeneca.com rizwan.shaik@astrazeneca.com"  < $HOME/temp.log
        exit -1
fi

js1=`ls -lrt jobserver1*_202* | tail -1 | awk '{ print $9 }'`
js2=`ls -lrt jobserver2*_202* | tail -1 | awk '{ print $9 }'`
c1=`fgrep -c 'File Monitor stopped' $js1`
c2=`fgrep -c 'File Monitor stopped' $js2`
...
then
        ...
        sleep 2
        #mailx -r "admin@eICEProd" -s  "Filemonitor Stopped..... Please Check.. URGENT!" "sathiskumar.raju@astrazeneca.com"  < $HOME/filemonitor.log
        #mailx -r "admin@eICEProd" -s  "Filemonitor Stopped..... Please Check immediately.." -c "sathiskumar.raju@astrazeneca.com purushothaman.krishnan@astrazeneca.com Rohit.Sharma2@astrazeneca.com vinod.sivakumar@astrazeneca.com juanpablo.ramirez@astrazeneca.com swetha.vuppalanchi@astrazeneca.com Michael.Forst2@astrazeneca.com abhinav.soti@astrazeneca.com rizwan.shaik@astrazeneca.com" "nikhil.toraskar@astrazeneca.com alfonso.gonzalez1@astrazeneca.com" < $HOME/filemonitor.log
        /usr/sbin/sendmail -t < /home/iceadminPD/scr/MAIL.txt
        /home/iceadminPD/scr/teams.sh
