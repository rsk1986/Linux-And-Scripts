...
mkdir CodeSnippet_Output_$day
find /entimice/filesystem/temp -maxdepth 1 -type f -name "CodeSnippet_Output*" -mmin +1440 -exec mv {} $log_target/CodeSnippet_Output_$day \;


find /entimice/filesystem/temp -maxdepth 1 -type f -name "CodeSnippet_Output*" -mmin +1440 -exec rm -rf {} \;
