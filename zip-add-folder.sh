...
[iceadminPD@server1 fileintegrity]$ pwd
/entimice/fileintegrity

[iceadminPD@server1 fileintegrity]$ ls -lrt
total 2612
...
[iceadminPD@server1 fileintegrity]$ zip -r fileintegrity.zip fileintegrity/
...
[iceadminPD@server1 fileintegrity]$ cat fileintegrity/FilesIntegrityChecker_PRD_9Jan2021_cdar/nohup.out
cat: fileintegrity/FilesIntegrityChecker_PRD_9Jan2021_cdar/nohup.out: Permission denied

[iceadminPD@server1 fileintegrity]$ ls -lrth
total 239M
