[iceadminPD@sesklentfspd01 ~]$ find /entimice/filesystem/temp -type f -name 'tmp_cmd_testdata_CR*' -exec ls -l {} \;
...
[iceadminPD@sesklentfspd01 ~]$ find /entimice/filesystem/temp -type f -name 'tmp_cmd_testdata_CR*' -exec mv {} {}.06Nov2020 \;
[iceadminPD@sesklentfspd01 ~]$
